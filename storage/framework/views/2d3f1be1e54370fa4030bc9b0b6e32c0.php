...
<?php endif; ?>
<?php $component->withAttributes(['x-bind:class' => 'open ? \'rotate-180\' : \'\'','class' => 'size-4 transition-transform']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <div x-show="open"
         ...
         class="<?php echo e($alignClass); ?> absolute top-full z-50 mt-1 w-60 overflow-hidden rounded-md border border-slate-200 bg-white py-1 shadow-lg ring-1 ring-slate-900/5">
        <?php echo e($slot); ?>

    </div>
</div>
<?php /**PATH D:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/ui/actions-menu.blade.php ENDPATH**/ ?>