<div class="space-y-4">
    <x-ui.page-header title="Importar clientes"
                       subtitle="Sube un archivo Excel o CSV y asigna cada columna a un campo de cliente.">
        <x-slot:actionsLeft>
            <x-ui.button as="a" href="{{ route('clientes.index') }}" wire:navigate
    ...
    @if ($procesado)
        <x-ui.card>
            ...
            <p class="mb-4 text-xs text-slate-500">
                Elige a qué campo de cliente corresponde cada columna del archivo. Las marcadas como
                «No usar» se ignoran. El campo <strong>Nombre / Razón social</strong> es obligatorio.
            </p>
            ...
            <div class="mb-3 flex items-start gap-2 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800">
                ...
                <div>
                    ...
                    <p class="text-red-700">
                        ...
                        Corrige el archivo y vuelve a subirlo: no se ha guardado ningún cliente.
                    </p>
                </div>
            </div>
