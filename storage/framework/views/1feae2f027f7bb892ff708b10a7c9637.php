...
<div <?php echo e($attributes->class('rounded-lg border border-slate-200 bg-white p-3 shadow-sm')); ?>>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title || $removeAction): ?>
        <div class="mb-2 flex items-center justify-between gap-2">
            <div class="min-w-0 flex-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title): ?>
                    <p class="truncate text-sm font-medium text-slate-700"><?php echo e($title); ?></p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($removeAction): ?>
                <button type="button"
                        wire:click="<?php echo e($removeAction); ?>"
...
<?php /**PATH D:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/mobile/line-card.blade.php ENDPATH**/ ?>