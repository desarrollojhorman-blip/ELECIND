...
<span class="inline-flex items-center gap-1.5 rounded-full bg-primary-50 px-2.5 py-1 text-xs font-medium text-primary-700">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($label): ?>
        <span class="text-primary-600/80"><?php echo e($label); ?>:</span>
...
<?php /**PATH C:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/ui/filter-chip.blade.php ENDPATH**/ ?>