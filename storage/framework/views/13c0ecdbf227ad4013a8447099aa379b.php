...
<header class="sticky top-0 z-20 flex h-14 shrink-0 items-center justify-between gap-2 bg-primary-700 px-3 text-white shadow"
    ...
    <div class="flex w-10 items-center justify-start">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showBack): ?>
            <a href="<?php echo e($backRoute ?? route('mobile.dashboard')); ?>"
...
<?php endif; ?>
    ...
    <div class="flex flex-1 items-center justify-center overflow-hidden"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title): ?>
            <h1 class="truncate text-base font-semibold"><?php echo e($title); ?></h1>
        <?php elseif($logoUrl): ?>
            <img x-show="! logoRoto" src="<?php echo e($logoUrl); ?>" alt="<?php echo e($marca); ?>"
                 style="max-height: calc(2rem * <?php echo e($logoZoom / 100); ?>);"
                 class="w-auto" x-on:error="logoRoto = true">
            <span x-show="logoRoto" x-cloak class="text-xs font-medium text-white/80">
                Imagen no disponible
            </span>
        <?php else: ?>
            <span class="text-lg font-bold tracking-wide"><?php echo e($marca); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<?php endif; ?>
        ...
        <div x-show="menuOpen"
            ...
            <div class="py-1">
                <a href="<?php echo e(route('mobile.perfil')); ?>"
...
<?php endif; ?>
                ...
                <a href="<?php echo e(route('mobile.incidencias.nueva')); ?>"
                   class="flex w-full items-center gap-2.5 px-3 py-2 text-sm transition-colors hover:bg-slate-50 hover:text-slate-900">
                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-4 shrink-0 text-amber-600']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()?->tieneAccesoWeb()): ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-4 shrink-0 text-blue-600']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH D:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/mobile/header.blade.php ENDPATH**/ ?>