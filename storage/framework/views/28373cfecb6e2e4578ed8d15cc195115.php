...
<th <?php echo e($attributes->class('px-4 py-3')); ?>>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-3.5 shrink-0 opacity-50']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <?php else: ?>
        <span class="block <?php echo e($alignClass); ?>"><?php echo e($slot); ?></span>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</th>
<?php /**PATH D:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/ui/sortable-header.blade.php ENDPATH**/ ?>