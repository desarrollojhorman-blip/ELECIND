...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($show): ?>
    <div class="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/50 p-4"
         <?php if($closeAction): ?> wire:keydown.escape.window="<?php echo e($closeAction); ?>" <?php endif; ?>>
        <div class="flex max-h-[calc(100vh-2rem)] w-full <?php echo e($sizes[$size] ?? $sizes['lg']); ?> flex-col overflow-hidden rounded-lg bg-white shadow-2xl ring-1 ring-slate-900/5"
             @click.outside="$wire.<?php echo e($closeAction); ?>()"
             wire:click.stop>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title || $closeAction): ?>
                <div class="flex shrink-0 items-center justify-between rounded-t-lg border-b border-accent-200 bg-accent-100 px-5 py-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($closeAction): ?>
                        <button type="button"
                                wire:click="<?php echo e($closeAction); ?>"
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/ui/modal.blade.php ENDPATH**/ ?>