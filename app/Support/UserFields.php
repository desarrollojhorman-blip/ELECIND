...
class UserFields
{
    ...
    public static function config(): array
    {
        return [
            ...
            'tasa_hora' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora labor diurna.'],
            'tasa_lab_noche' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora labor nocturna.'],
            'tasa_festivo' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora festivo diurno.'],
            'tasa_fest_noche' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora festivo nocturno.'],
            'tasa_extra' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora extra laboral diurna.'],
            'tasa_ex_lab_noc' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora extra laboral nocturna.'],
            'tasa_ex_fes' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora extra festiva diurna.'],
            'tasa_ex_fes_noct' => ['type' => 'number', 'validation' => 'tasa', 'help' => '€/hora extra festiva nocturna.'],
