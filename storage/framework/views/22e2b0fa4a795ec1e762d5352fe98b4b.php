...
<aside x-data="{
    ...
    <div class="flex h-16 items-center justify-between gap-2 border-b border-slate-200 px-3">
        <a href="<?php echo e(route('web.dashboard')); ?>" class="flex min-w-0 flex-1 items-center justify-center overflow-hidden">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoUrl): ?>
                
                <img x-show="open" x-transition.opacity src="<?php echo e($logoUrl); ?>" alt="<?php echo e($marca); ?>" class="max-h-9 w-auto">
                
                <img x-show="! open" x-transition.opacity src="<?php echo e($logoUrl); ?>" alt="<?php echo e($marca); ?>" class="size-8 object-contain">
            <?php else: ?>
    ...
    <nav class="flex-1 overflow-y-auto px-2 py-3">
        <ul class="space-y-0.5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($item['children']) && $item['route'] === null && count($childrenVisibles) === 0): ?>
                    <?php continue; ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
