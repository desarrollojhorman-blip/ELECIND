...
<div <?php echo e($attributes->class('flex flex-col gap-1')); ?>>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($label): ?>
        <label <?php if($for): ?> for="<?php echo e($for); ?>" <?php endif; ?> class="text-xs font-medium text-slate-600">
            <?php echo e($label); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($error): ?>
        <p class="text-xs text-red-600"><?php echo e($error); ?></p>
    <?php elseif($hint): ?>
        <p class="text-xs text-slate-500"><?php echo e($hint); ?></p>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php /**PATH C:\xampp\htdocs\CLIENTES\ELECIND\resources\views/components/ui/field.blade.php ENDPATH**/ ?>