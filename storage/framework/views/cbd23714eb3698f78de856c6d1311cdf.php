...
<head>
    ...
    <title><?php echo e(\App\Support\Branding::nombre()); ?> · Iniciar sesión</title>
    ...
    <div class="flex min-h-screen flex-col items-center justify-center px-4 py-12">
        ...
        <div class="w-full max-w-sm">
            ...
            <div class="mb-8 flex flex-col items-center gap-3">
                <?php $logoUrl = \App\Support\Branding::logoUrl(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoUrl): ?>
                    <img src="<?php echo e($logoUrl); ?>"
                         alt="<?php echo e(\App\Support\Branding::nombre()); ?>"
                         class="h-14 w-auto object-contain"
                         style="max-height: calc(3.5rem * <?php echo e(\App\Support\Branding::logoZoom() / 100); ?>);">
                <?php else: ?>
                    <div class="flex size-14 items-center justify-center rounded-xl text-white text-2xl font-bold"
                        ...
                        <?php echo e(\App\Support\Branding::abreviatura()); ?>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4" x-data="{ mostrarPassword: false }">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                            ...
                            <input id="username"
                                   ...
                                   class="block w-full rounded-lg border border-slate-300 py-2.5 pl-10 pr-3 text-sm text-slate-900 placeholder-slate-400 focus:border-primary-700 focus:outline-none focus:ring-1 focus:ring-primary-700 <?php $__errorArgs = ['username'];
...
<?php endif; ?>
                            ...
                            <input id="password"
                                   ...
                                   class="block w-full rounded-lg border border-slate-300 py-2.5 pl-10 pr-10 text-sm text-slate-900 placeholder-slate-400 focus:border-primary-700 focus:outline-none focus:ring-1 focus:ring-primary-700 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => '!mostrarPassword','class' => 'size-4']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'mostrarPassword','class' => 'size-4','x-cloak' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <p class="mt-6 text-center text-xs text-slate-500">
                ENIA &middot; v<?php echo e(config('app.version', '1.0')); ?>
...
<?php /**PATH D:\xampp\htdocs\CLIENTES\ELECIND\resources\views/auth/login.blade.php ENDPATH**/ ?>