                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex flex-wrap gap-2 pt-1">
                                @if ($form->nuevoLogoAlbaran)
                                    <x-ui.button size="sm" variant="ghost" wire:click="descartarNuevoLogoAlbaran" type="button">
                                        Descartar selección
                                    </x-ui.button>
                                @elseif ($form->logo_albaran_path && ! $form->eliminarLogoAlbaran)
                                    <x-ui.button size="sm" variant="danger" wire:click="quitarLogoAlbaran" type="button" icon="heroicon-o-trash">
                                ...
                                @elseif ($form->eliminarLogoAlbaran)
                                    ...
                                    <x-ui.button size="sm" variant="ghost" wire:click="cancelarQuitarLogoAlbaran" type="button">
                                        Cancelar
                                    </x-ui.button>
                                @endif
                            </div>
